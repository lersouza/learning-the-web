...
public class ThreadedServer {
    ...
    public ThreadedServer(final ServerDefinition definition) {
   ...
   /**
        ...
        try {
            ...
            while(true) {
                ...
                Thread requestThread = new Thread(new Runnable(){
	                ...
	                public void run() {
	                    try {
                            ThreadedServer.this.handleConnection(clientSocket);
                        }
                        catch(IOException ioEx) {
                            LOGGER.error("IO Error when gandling client", ioEx);
                        }
		            }
                });
    ...
    public static void main(final String[] args) {
        ...
        final ThreadedServer server = new ThreadedServer(definition);
